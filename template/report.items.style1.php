<a class="report-items style1" href="goto/<?php echo $var['report_id'];?>" target="_blank">
	<div class="cover"><img src="image/upload/normal/<?php echo $var['report_image_file'];?>" alt=""></div>
	<div class="detail">
